...
<a href="homepage.html"><img src="images/solodrinkerlogo.gif" class="img-rounded" style="position:absolute;z-index:2;display: block;margin-left:850px"></a>
...
<div style="padding:1em;align-center;width:20%;margin:auto;">
...
<br>
<a class="btn btn-primary btn-xl" id="b2" href="SearchServlet" role="button"  style="background-color:#4CAF50;float:left;">See Nearby Solo's</a>
<br>
<a class="btn btn-primary btn-xl" id="b3" href="login.jsp" role="button" style="background-color:#4CAF50;float:left;">Register in order to</a>
